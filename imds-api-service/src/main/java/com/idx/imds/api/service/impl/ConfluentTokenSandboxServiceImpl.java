...
import com.idx.imds.api.service.configuration.ConfluentSandboxConfiguration;

@Service("confluentTokenSandboxService")
public class ConfluentTokenSandboxServiceImpl implements ConfluentTokenService {

	private static Logger log = LogManager.getLogger(ConfluentTokenServiceImpl.class);
	@Autowired
	private ConfluentSandboxConfiguration confluentConfig;
